...
const Search = (props) => {
  ...
  return (
    <div className={`${classPrefix}-home-personnel-transfer-search`}>
      <div className={`${classPrefix}-home-personnel-transfer-search-content`}>
        <Form {...layout} name="nest-messages" onFinish={onFinish} form={form}>
          <Row>
            ...
            <Col span={colSpan}>
              <Form.Item name={["missionTimeArr"]} label="调动日期">
