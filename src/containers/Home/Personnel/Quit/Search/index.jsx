...
const Search = (props) => {
  ...
  return (
    <div className={`${classPrefix}-home-personnel-quit-search`}>
      <div className={`${classPrefix}-home-personnel-quit-search-content`}>
        <Form {...layout} name="nest-messages" onFinish={onFinish} form={form}>
          <Row>
            ...
            <Col span={colSpan}>
              <Form.Item name={["missionTimeArr"]} label="预计离职日期">
