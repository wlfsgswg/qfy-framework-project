...
const Search = (props) => {
  ...
  const onFinish = (values) => {
    ...
    const dateArr = ["conversionTimeArr"];
  ...
  return (
    <div className={`${classPrefix}-home-personnel-contract-search`}>
      <div className={`${classPrefix}-home-personnel-contract-search-content`}>
        <Form {...layout} name="nest-messages" onFinish={onFinish} form={form}>
          <Row>
            ...
            <Col span={colSpan}>
              <Form.Item name={["conversionTimeArr"]} label="合同到期日期">
